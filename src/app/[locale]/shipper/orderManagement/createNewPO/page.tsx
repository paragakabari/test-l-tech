...
import Styles from "./createNewPO.module.css"
...
const Page = ({ params: { locale } }) => {
    ...
    const data = [
        { orderNumber: 'Order_1728', pickup: 'Jeddah', marketplace: 'e-Procure', pickupType: 'Fragile', dimension: 'Add', weight: 'Add', qty: 'Add' },
        { orderNumber: 'Order_1728', pickup: 'Doha', marketplace: 'Alibaba', pickupType: 'Hardware', dimension: 'Add', weight: 'Add', qty: 'Add' },
        { orderNumber: 'Order_1728', pickup: 'Riyad', marketplace: 'e-Procure', pickupType: 'Photo Printers', dimension: 'Add', weight: 'Add', qty: 'Add' },
        { orderNumber: 'Order_1728', pickup: 'Jeddah', marketplace: 'Amazon', pickupType: 'Pet Supplies', dimension: 'Add', weight: 'Add', qty: 'Add' },
    ];
            ...
            render: (value, row) => (
                <div className={Styles.actionButtons}>
                    <div className={`${Styles.actionButton} ${Styles.postInquiryButton}`}>
                        <span className='text-danger fw-light cursor-pointer' onClick={() => router.push(`/${locale}/shipper/orderManagement/createNewPODetails`)}>Create PO</span>
                    </div>
                </div>
            ),
        },
    ...
    return (
        <div className='position-relative'>
            <div className={Styles.secondDashBoard}>
                <HeroThree BoldText='Create New PO' breadcrumb={breadcrumb} Description="Pending orders Listing (Imported from various Marketplace)" />
