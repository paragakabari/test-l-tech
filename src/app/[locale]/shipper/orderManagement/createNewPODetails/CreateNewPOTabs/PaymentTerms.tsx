                    ...
                    <Row className='gy-4'>
                        <Col lg={12}>
                            <div className={Styles.ContractPaymentTermsMain}>
                                <div className={`${Styles.paymentOptionMain} mt-0`}>
                                    <Row className='gy-4'>
                                        <Col lg={12}>
                                            <h1>Contract Cost Card</h1>
                            ...
                            <div className={Styles.boldTextPrice}>
                                <div className='d-flex justify-content-between align-items-center mt-4'>
                                    <div>
                                        ...
                                        <small>Base Cost For 800Km</small>
                                    </div>
                                    <div className='text-end'>
                                        <div className='d-flex align-items-center gap-2'>
                                            <p className='fw-semibold'>990</p><small>SAR</small>
                                        </div>
                                        <small>990 SAR</small>
                                    </div>
                                </div>
                                <div className='d-flex justify-content-between align-items-center'>
                                    <div>
                                        <small>Add. Distance Cost (150Km)</small>
                                        <p className='fw-semibold'>Total Cost For 950 Km</p>
                                    </div>
                                    <div className='text-end'>
                                        <small>450 SAR</small>
                                        <div className='d-flex align-items-center gap-2'>
                                            <p className='fw-semibold'>1440</p><small>SAR</small>
                                        </div>
                                    </div>
                                </div>
                                <div className='d-flex justify-content-between align-items-center mt-4'>
                                    <div>
                                        ...
                                        <small>Base Cost(500-600Kg)</small>
                                    </div>
                                    <div className='text-end'>
                                        <div className='d-flex align-items-center gap-2'>
                                            <p className='fw-semibold'>590</p><small>SAR</small>
                                        </div>
                                        <small>600 SAR</small>
                                    </div>
                                </div>
                                <div className='d-flex justify-content-between align-items-center'>
                                    <div>
                                        <small>Additional Weight Cost (0Kg)</small>
                                        <p className='fw-semibold'>Total Cost For 590 Kg</p>
                                    </div>
                                    <div className='text-end'>
                                        <small>0 SAR</small>
                                        <div className='d-flex align-items-center gap-2'>
